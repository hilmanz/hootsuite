...
<div class="ss_stream_msg ss_container" data-bind="visible:is_forum_analytics">
    <div class="ss_chart">
        <div class="chartbox">
            <h3 class="chart-title">Daily Threads</h3>
            <div id="daily-threads-chart" class="linechart" style="min-width: 310px; height: 240px;"></div>
        </div>
        <div class="chartbox">
            <h3 class="chart-title">Threads</h3>
            <h4 class="numbers" data-bind="text:threads"></h4>
        </div>
        <div class="chartbox">
            <h3 class="chart-title">Replies</h3>
            <h4 class="numbers" data-bind="text:forum_replies"></h4>
        </div>
       
        <div class="chartbox">
            <h3 class="chart-title">Sentiments</h3>
            <div id="forum-sentiment-chart" class="stackchart" style="min-width: 150px; height: 240px; max-width: 600px;"></div>
        </div>
    </div><!--hs_message-->
</div><!--ss_login-->
