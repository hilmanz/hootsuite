...
<div class="ss_stream_msg ss_container" data-bind="visible:is_media_analytics">
    <div class="ss_chart">
        <div class="chartbox">
            <h3 class="chart-title">Daily Articles</h3>
            <div id="daily-articles-chart" class="linechart" style="min-width: 310px; height: 240px;"></div>
        </div>
        <div class="chartbox">
            <h3 class="chart-title">Comments</h3>
            <h4 class="numbers" data-bind="text:media_comments"></h4>
        </div>
        <div class="chartbox">
            <h3 class="chart-title">Posts</h3>
            <h4 class="numbers" data-bind="text:media_posts"></h4>
        </div>
        <div class="chartbox">
            <h3 class="chart-title">Total Reach</h3>
            <h4 class="numbers" data-bind="text:media_total_reach"></h4>
        </div>
        <div class="chartbox">
            <h3 class="chart-title">Engagement Rate</h3>
            <h4 class="numbers" data-bind="text:media_engagement_rate"></h4>
        </div>
        <div class="chartbox">
            <h3 class="chart-title">Coverage</h3>
            <div id="media-coverage-chart" class="piechart" style="min-width: 150px; height: 240px; max-width: 600px;"></div>
        </div>
        <div class="chartbox">
            <h3 class="chart-title">Sentiments</h3>
            <div id="media-sentiment-chart" class="stackchart" style="min-width: 150px; height: 240px; max-width: 600px;"></div>
        </div>
    </div><!--hs_message-->
</div><!--ss_login-->
